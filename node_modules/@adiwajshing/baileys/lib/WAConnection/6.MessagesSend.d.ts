...
import { MessageOptions, MessageType, WALocationMessage, WAContactMessage, WAContactsArrayMessage, WAGroupInviteMessage, WAListMessage, WATextMessage, WAMessageContent, WAMessage, WAMessageProto, MediaConnInfo, WAMediaUpload } from './Constants';
...
export declare class WAConnection extends Base {
     ...
     */
    sendMessage(id: string, message: string | WATextMessage | WALocationMessage | WAContactMessage | WAContactsArrayMessage | WAGroupInviteMessage | WAMediaUpload | WAListMessage, type: MessageType, options?: MessageOptions): Promise<WAMessageProto.WebMessageInfo>;
    /**
     * Send a list message
     * @param id the id to send to
    ...
    prepareMessage(id: string, message: string | WATextMessage | WALocationMessage | WAContactMessage | WAContactsArrayMessage | WAGroupInviteMessage | WAMediaUpload | WAListMessage, type: MessageType, options?: MessageOptions): Promise<WAMessageProto.WebMessageInfo>;
    /**
    ...
    prepareMessageContent(message: string | WATextMessage | WALocationMessage | WAContactMessage | WAContactsArrayMessage | WAGroupInviteMessage | WAMediaUpload | WAListMessage, type: MessageType, options: MessageOptions): Promise<WAMessageProto.Message>;
