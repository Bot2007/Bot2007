...
global.fakethumb = await (await require('node-fetch')('https://i.ibb.co/0tbBShq/IMG-20210705-WA0886.jpg')).buffer()const jamID = moment.tz('Asia/Jakarta').format('HH')
...
%readmore`
    ...
    m.reply(text.trim(), null,  { thumbnail: global.fakethumb, contextInfo: { mentionedJid, forwardingScore: 508, isForwarded: true, "externalAdReply": {
                  "title": "Taufik Bot",
