...
conn.browserDescription = ["Taufikbot", "Handphone", '10.0']
...
// FakeThumb
global.fakethumb = async m => {
Taufik = await await require('node-fetch')('https://i.ibb.co/0tbBShq/IMG-20210705-WA0886.jpg').buffer()
}
